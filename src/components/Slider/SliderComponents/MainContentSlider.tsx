...
export const MainContentSlider = memo(() => {
  ...
  return (
    <div className="grow pt-6 px-4 flex flex-col gap-8">
      <UiSelect options={typeUserOption} label="Тип пользователей" fieldKey="type" value={fields.type} onChange={changeField} />
      <UiInput label="Логин" fieldKey="login" value={fields.login} onChange={changeField} />
